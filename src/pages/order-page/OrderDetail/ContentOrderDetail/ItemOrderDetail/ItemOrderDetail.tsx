             ...
             {/* <div style={{display:"flex", flexDirection:"row"}} >
               ...
               <div style={{display:"flex", flexDirection:"row", alignItems:"center", justifyContent:"center" }}>
                <div style={{ fontWeight: "500", marginRight:"0.5rem", cursor:"pointer"}}>Số lượng: </div>
                 <MinusCircleOutlined onClick={() => handleDecreaseAmount(data)} className="icon-control-amount" rev={undefined}  />
                <div style={{padding:"0.3rem", fontSize:"1rem"}}>{data?.amount}</div>
                 <PlusCircleOutlined onClick={() => handleIncreaseAmount(data)} className="icon-control-amount" rev={undefined} />
               </div>
          </Col>
          <Col span={2}>
